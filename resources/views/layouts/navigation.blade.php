<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('admin.library.index')" :active="request()->routeIs('admin.library.index')">
                {{ __('Library') }}
            </x-responsive-nav-link>
        </div>
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('admin.author.index')" :active="request()->routeIs('admin.author.index')">
                {{ __('Author') }}
            </x-responsive-nav-link>
        </div>

        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('admin.book.index')" :active="request()->routeIs('admin.book.index')">
                {{ __('Book') }}
            </x-responsive-nav-link>
        </div>
